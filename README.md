...
1.  **Local Training (MLP):** Users capture hand landmarks via webcam. A Neural Network (Multi-Layer Perceptron) is trained _instantly_ in-browser using TensorFlow.js.
